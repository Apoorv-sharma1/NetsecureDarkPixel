  ...
  head: () => ({
    meta: [
      { title: "NetSecure Foundation | Free Cyber Awareness NGO Jaipur, Rajasthan" },
      {
        name: "description",
        content:
          "NetSecure Foundation is Rajasthan's leading cybercrime awareness NGO. Free cyber safety education for students, women & professionals across Rajasthan. Join the movement.",
      },
      {
        property: "og:title",
        content: "NetSecure Foundation | Free Cyber Awareness NGO Jaipur, Rajasthan",
      },
      {
        property: "og:description",
        content:
          "Free cyber safety education for students, women & professionals across Rajasthan. Join the movement.",
      },
...
const CAMPAIGNS = [
  {
    title: "Cyber Awareness — MBN School",
    venue: "Jaipur",
    date: "Apr 2026",
    initiative: "Cyber Shiksha Abhiyan",
    slug: "cyber-shiksha-abhiyan",
    image: "https://lh3.googleusercontent.com/d/1S7LgOaMFCj9xiwKrHC5p3d0cF_p2r5mU",
  },
  {
    title: "Digital Immunity Drive",
    venue: "Amity University, Jaipur",
    date: "Mar 2026",
    initiative: "Digital Immunity Drive",
    slug: "digital-immunity-drive",
    image: "https://lh3.googleusercontent.com/d/1szj-HTn_IbSi89oHmoD1vPK1h3Mo9-uA",
  },
  {
    title: "Women's Safety Workshop",
    venue: "RU Law University",
    date: "Feb 2026",
    initiative: "TechSHEcurity",
    slug: "techshecurity",
    image: "https://lh3.googleusercontent.com/d/1tfh1K8RnjHUV2JsIf0unR-hYHT87sQKB",
  },
  {
    title: "TechSHEcurity Workshop",
    venue: "Ibtada Foundation",
    date: "Jan 2026",
    initiative: "TechSHEcurity",
    slug: "techshecurity",
    image: "https://lh3.googleusercontent.com/d/1IeVvbEeyKap5GEmC_czNZmfYpkKHdebt",
  },
  {
    title: "Women's Safety Drive",
    venue: "RU Law College",
    date: "Jan 2026",
    initiative: "TechSHEcurity",
    slug: "techshecurity",
    image: "https://lh3.googleusercontent.com/d/1pPDTlSQrhpbvvIXv50miEFfKIZys4Bml",
  },
  {
    title: "Public Drive",
    venue: "Patrika Gate, Jaipur",
    date: "Feb 2026",
    initiative: "Digital Immunity Drive",
    slug: "digital-immunity-drive",
    image: "https://lh3.googleusercontent.com/d/1ibSugT5wBxTYOoWNiYagsCjQRzLSnN-y",
  },
  {
    title: "Govt. School Cyber Drive",
    venue: "Varun Path, Jaipur",
    date: "Jan 2026",
    initiative: "Cyber Shiksha Abhiyan",
    slug: "cyber-shiksha-abhiyan",
    image: "https://lh3.googleusercontent.com/d/1Lh2YcHvM5OGAkwJDUFlDE2DVJFdPF4ox",
  },
  {
    title: "Cyber Vaccine Session",
    venue: "Ibtada NGO",
    date: "Jan 2026",
    initiative: "Cyber Vaccine",
    slug: "cyber-vaccine",
    image: "https://lh3.googleusercontent.com/d/1vwSNbbzyrFnvp-razrkuACYGq6eZQ6l2",
  },
  {
    ...
    initiative: "TechSHEcurity",
    slug: "techshecurity",
    image: "https://lh3.googleusercontent.com/d/1NrZRkbullyntToECB3X-9V6XA1Y32G3J",
  },
];
...
const TEAM = [
  {
    ...
    bio: "Cybersecurity educator and founder of NetSecure Foundation. Leads programme strategy across Rajasthan.",
  },
  {
    name: "Roopesh Sharma",
    role: "Vice President & Program Lead",
    bio: "Designs and delivers field workshops; oversees volunteer training and partnerships.",
  },
  {
    name: "Mohit Sankhla",
    role: "General Secretary",
    bio: "Drives operations, compliance, and outreach to schools, colleges and NGOs.",
  },
];
  ...
  return (
    <SiteLayout>
      ...
      <section className="gradient-hero relative overflow-hidden text-primary-foreground">
        ...
        <div className="home-hero-grid container-prose relative grid gap-12 py-20 md:py-28 lg:grid-cols-[minmax(0,0.95fr)_minmax(360px,1.05fr)] lg:items-center lg:gap-16 xl:gap-20">
          <div className="home-hero-copy animate-fade-up">
            ...
            <h1 className="hero-title text-4xl font-bold leading-[1.05] md:text-5xl lg:text-6xl">
              <span className="block">Protecting India,</span>
              <span className="block">
                <span className="text-teal">one click</span>
              </span>
            ...
            <p className="mt-6 max-w-xl text-balance text-base text-primary-foreground/75 md:text-lg">
              Free cybercrime awareness education for students, women, professionals and communities
              across Rajasthan — delivered in Hindi, on the ground, by trained volunteers.
            </p>
          ...
          <div className="home-hero-media relative lg:justify-self-end">
        ...
        <div className="flex flex-col gap-4">
          <Marquee speed={40} direction="left">
            {MARQUEE_ITEMS.map((item, idx) => (
              <div
                key={`row1-${idx}`}
                className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-6 py-2.5 text-sm font-medium text-white shadow-lg backdrop-blur-md transition-colors hover:bg-white/10"
              >
      ...
      <Section className="bg-background">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-balance font-display text-2xl font-semibold leading-snug text-foreground md:text-3xl">
            ...
            healthcare worker in Sikar — to recognise, prevent and respond to cybercrime. Because
              ...
              <div className="grid gap-8 lg:grid-cols-2">
                ...
                >
                  ...
                  <p className="mb-8 text-sm leading-relaxed text-primary-foreground/70">
                    This initiative is aimed at {i.audience}. Our volunteers conduct in-depth
                    sessions to build digital resilience.
                  </p>
                  <Link
                    to="/initiatives/$slug"
                    params={{ slug: i.slug }}
                ...
                >
                  ...
                  <div className="relative grid h-full w-full grid-cols-2 gap-2 rounded-2xl border border-border bg-card/70 p-4 shadow-sm backdrop-blur-sm md:grid-cols-3">
      ...
      <Section className="bg-surface-alt">
        ...
        >
          ...
          <div className="mt-6 text-sm font-medium">
            — Principal, Govt. School Mansarovar ·{" "}
            <span className="text-muted-foreground">Cyber Shiksha Abhiyan</span>
          </div>
        </motion.div>
      </Section>
      ...
      <section className="bg-primary py-20 text-primary-foreground">
        <div className="container-prose text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link
              to="/engage"
              className="rounded-lg bg-saffron px-6 py-3 text-sm font-bold text-saffron-foreground transition hover:brightness-110"
            >
              Join the Movement
            </Link>
            <Link
              to="/engage"
              className="rounded-lg border-2 border-teal px-6 py-3 text-sm font-bold text-teal transition hover:bg-teal hover:text-teal-foreground"
            >
              Become a Volunteer
            </Link>
            <Link
              to="/donate"
              className="rounded-lg bg-background px-6 py-3 text-sm font-bold text-primary transition hover:brightness-95"
            >
              Donate Now
            </Link>
          </div>
